...
export const integranteSchema = z.object({
  ...
  grupoPoblacionalOtro: z.string().optional().nullable(),
  barrerasAcceso: z.array(z.coerce.number()).default([]),
  barrerasAccesoOtro: z.string().optional().nullable(),
  discapacidades: z.array(z.coerce.number()).default([]),
  discapacidadesOtro: z.string().optional().nullable(),

  // V. EVALUACIÓN SALUD (Step 5)
  antecedentes: z.union([z.record(z.boolean()), z.array(z.string())]).optional().default({}),
  antecedentesOtro: z.string().optional().nullable(),
  antecTransmisibles: z.union([z.record(z.boolean()), z.array(z.string())]).optional().default({}),
  antecTransmisiblesOtro: z.string().optional().nullable(),
...
export const wizardSchema = z.object({
  ...
  animalesOtro: z.string().optional().nullable(),
