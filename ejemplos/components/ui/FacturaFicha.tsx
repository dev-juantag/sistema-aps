...
export default function FacturaFicha({ ficha, autoPrint }: { ficha: any, autoPrint?: boolean }) {
  ...
  const integranteChunks = chunkArray(ficha.integrantes || [], 3);
  ...
  return (
    <div className="hidden print:block font-sans text-black bg-white w-full max-w-none mx-auto p-4 leading-normal">
